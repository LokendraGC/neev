@extends('layouts.vertical', ['page_title' => 'All Media', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box py-3 d-flex justify-content-start align-content-center  gap-2">
                    ...
                    <div>
                        <a href="{{ route('backend.media.create') }}" class="btn btn-outline-primary">Add New Media</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="mb-2">
                            <div class="row-action">
                                ...
                                @if ($publishPosts > 0)
                                    <span class="publish">
                                        |
                                        <a href="{{ route('backend.media', ['status' => 'publish']) }}" class="">
                                ...
                                @if ($draftPosts > 0)
                                    <span class="draft">
                                        |
                                        <a href="{{ route('backend.media', ['status' => 'draft']) }}" class="">
                                            <span
                                    ...
                                    @foreach ($posts as $post)
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row-action">
                                                    <span class="edit">
                                                        <a href="{{ route('backend.media.edit', $post->id) }}"
