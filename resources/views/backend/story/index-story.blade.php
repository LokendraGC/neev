@extends('layouts.vertical', ['page_title' => 'All Stories', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box py-3 d-flex justify-content-start align-content-center  gap-2">
                    ...
                    <div>
                        <a href="{{ route('backend.story.create') }}" class="btn btn-outline-primary">Add New Story</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="mb-2">
                            <div class="row-action">
                                ...
                                @if ($publishPosts > 0)
                                    <span class="publish">
                                        |
                                        <a href="{{ route('backend.story', ['status' => 'publish']) }}" class="">
                                ...
                                @if ($draftPosts > 0)
                                    <span class="draft">
                                        |
                                        <a href="{{ route('backend.story', ['status' => 'draft']) }}" class="">
                                            <span
                                    ...
                                    @foreach ($posts as $post)
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row-action">
                                                    <span class="edit">
                                                        <a href="{{ route('backend.story.edit', $post->id) }}"
                                                    ...
                                                    <span class="view">
                                                        |
                                                        <a href="{{ route('frontend.story.index', $post->slug) }}"
