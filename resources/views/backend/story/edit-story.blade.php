@extends('layouts.vertical', ['page_title' => 'Edit Story', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
<div class="container-fluid">
    ...
    <form method="POST" action="{{ route('backend.story.update', $post->id) }}">
        @csrf
        <div class="row">
            <div class="col-md-9">
                {{-- main content --}}
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-2 d-flex align-content-center border-1 border-bottom">
                                    <h4 class="header-title">Single Story Builder</h4>
                                </div>
            ...
            <div class="col-md-3">
                ...
                {{-- publish / submit --}}
                <x-backend.post.status :post="$post" route="frontend.story.index" button="Update" />
                ...
                {{-- sector categories --}}
                @php
                $selectedCategories = isset($metaDatas['sector_categories']) ? unserialize($metaDatas['sector_categories']) : [];
                @endphp
