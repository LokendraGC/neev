@extends('layouts.vertical', ['page_title' => 'Add New Story', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add New Story</h4>
                </div>
            </div>
        </div>
        <form method="POST" action="{{ route('backend.store.story') }}">
            @csrf
            <div class="row">
                <div class="col-md-9">
