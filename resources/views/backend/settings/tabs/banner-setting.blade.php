<div class="tab-pane fade {{ request()->query('tab') == 'banner-section' ? 'active show' : '' }}" id="banner-section" role="tabpanel"
    aria-labelledby="banner-section-tab">
    <div class="">
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    <label for="banner_background_image" class="form-label">Banner Background Image</label>
                    <div class="input-group open-media-manager" data-bs-toggle="modal" data-bs-target="#exampleModal"
                        style="cursor: pointer;" data-field="banner_background_image" data-select="single">
                    ...
                    <div class="preview-closer">
                                ...
                                <div class="file-preview box sm">
                                    <div
                                        ...
                                        <div class="remove"><button data-id="{{ $media->id }}"
                                                data-slug="banner_background_image" class="btn btn-sm btn-link remove-attachment"
                        ...
                        @else
                            <input type="hidden" id="banner_background_image" name="banner_background_image" class="selected-files"
                                value="" />
                            <div id="banner_background_image_select"></div>
                        @endisset
                </div>
