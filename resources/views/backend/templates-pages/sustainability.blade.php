<div class="row">
   <div class="col-md-12">
       <div class="mb-3">
           <label for="sustainability_image" class="form-label">Upload Sustainability Image</label>
           <div class="input-group open-media-manager" data-bs-toggle="modal"
           data-bs-target="#exampleModal" style="cursor: pointer;" data-field="sustainability_image"
           data-select="single">
       ...
       <div class="preview-closer">
        @if (isset($metaDatas['sustainability_image']) &&
        ($media = MediaHelper::getModel()->where('id', $metaDatas['sustainability_image'])->first()))
        
        <input type="hidden" id="sustainability_image" name="sustainability_image"
        class="selected-files" value="{{ $metaDatas['sustainability_image'] }}">

        <div id="sustainability_image_select">
                ...
                <div class="d-flex justify-content-between align-items-center mt-2 file-preview-item">
                    ...
                    <div class="remove">
                        <button data-id="{{ $media->id }}"
                            data-slug="sustainability_image"
        ...
        <div id="sustainability_image_select"></div>
        @endif
    </div>
