@extends('layouts.vertical', ['page_title' => 'All Companies', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="col-12">
                <div class="page-title-box py-3 d-flex justify-content-start align-content-center  gap-2">
                    {{-- <div class="align-self-center">
                        <h4 class="page-title" style="line-height: unset;">Companies</h4>
                    </div> --}}
                    <div>
                        <a href="{{ route('backend.company.create') }}" class="btn btn-outline-primary">Add New Company</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="mb-2">
                            <div class="row-action">
                                ...
                                @if ($publishPosts > 0)
                                    <span class="publish">
                                        |
                                        <a href="{{ route('backend.company', ['status' => 'publish']) }}" class="">
                                ...
                                @if ($draftPosts > 0)
                                    <span class="draft">
                                        |
                                        <a href="{{ route('backend.company', ['status' => 'draft']) }}" class="">
                                            <span
                                    ...
                                    @foreach ($posts as $post)
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row-action">
                                                    <span class="edit">
                                                        <a href="{{ route('backend.company.edit', $post->id) }}"
                                                    ...
                                                    <span class="view">
                                                        |
                                                        <a href="{{ route('frontend.company.index', $post->slug) }}"
