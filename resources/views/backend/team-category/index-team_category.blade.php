            ...
            <div class="col-lg-5">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('backend.category.team_category.store') }}">
                            @csrf
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="row-action">
                                                    <span class="edit">
                                                        <a href="{{ route('backend.category.team_category.edit', $category->id) }}"
                                                            class="text-primary">Edit</a>
                                                    </span>
                                                    <span class="delete">
                                                        |
                                                        <a href="{{ route('backend.category.team_category.delete', $category->id) }}"
