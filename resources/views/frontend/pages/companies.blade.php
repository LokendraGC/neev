            ...
            <div class="page-heading">
                <ul class="breadcrumb-items wow fadeInUp" data-wow-delay=".5s">
                    ...
                    @if (!empty($business_page))
                        <li><a href="{{ route('frontend.post.index', $business_page->slug) }}">{{ $business_page->post_title }}</a>
                        </li>
                        <li>/</li>
                    @endif
                    ...
                    @foreach ($companies as $company)
                        <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                            <div class="news-box-items mt-0">
                              ...
                              $company_meta = $company->GetAllMetaData();
                              
                              
                              $media = MediaHelper::getImageById($company_meta['featured_image']);
                              ...
                              @endphp
                                ...
                                <div class="content">
                                    <ul>
                                        ...
                                        <li>
                                            <span>{{ $company->post_date }}</span>
                                        </li>
                                    </ul>
                                    <h3>
                                        <a href="{{ route('frontend.company.index', $company->slug) }}">{{ $company->post_title }}</a>
                                    </h3>
                                    <div class="news-bottom">
                                        <a href="{{ route('frontend.company.index', $company->slug) }}" class="link-btn">
